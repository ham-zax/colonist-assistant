...
struct ConfigReport {
    ...
    posterior_mode: &'static str,
    opponent_class: &'static str,
    root_preparation_mode: &'static str,
    final_arbitration_mode: &'static str,
...
fn paired_state_chunk(
    ...
    for local_block in 0..blocks {
        ...
        for seat in 0..players {
            let mut state =
                GameState::from_generator(strength_board_generator(players), seed, players)
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let output = Output {
        ...
        config: ConfigReport {
            ...
            information_mode: "resident-authoritative-game-state",
            posterior_mode: "none-single-realized-state",
            opponent_class: "gpu-weighted-rollout-policy",
            root_preparation_mode: "benchmark-sampled-root-actions",
            final_arbitration_mode: "benchmark-search-winner-no-live-post-search-arbitration",
